// ============================================================
// FF HUB — shared navigation shell (Flat Root Version)
...
export function renderShell(activeKey) {
  ...
  shell.insertAdjacentHTML("afterbegin", `
    <div class="topbar">
      <a href="index.html" class="brand"><span class="mark">FF</span> HUB</a>
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <div class="sidebar-foot" id="sidebarFoot">
        <a href="login.html">Player / admin login →</a>
      </div>
    </aside>
  `);
  ...
  onAuthStateChanged(auth, async (user) => {
    ...
    if (!foot) return;
    if (!user) {
      foot.innerHTML = `<a href="login.html">Player / admin login →</a>`;
      return;
    }
    ...
    if (admin) {
      foot.innerHTML = `
        ...
        <a href="admin-dashboard.html">Admin panel →</a><br>
      ...
      foot.innerHTML = `
        ...
        <a href="player-dashboard.html">My dashboard →</a><br>
        <a href="#" id="navSignOut">Sign out</a>
      `;
    }
